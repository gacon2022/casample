...
public class ExamMemberAnswerDetailEntity implements Entity {
    ...
    public ExamMemberAnswerDetailEntity() {
    }

    public ExamMemberAnswerDetailEntity(int examMemberAnswerDetailId, int examMemberAnswerId, int answerId, String otherAnswer, String description) {
        this.examMemberAnswerDetailId = examMemberAnswerDetailId;
        this.examMemberAnswerId = examMemberAnswerId;
        this.answerId = answerId;
        this.otherAnswer = otherAnswer;
